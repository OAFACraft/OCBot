...
# help pages
page1 = discord.Embed(title="📻 Boombox 📻", description="Players can now craft and listen to their own personal Boombox!\nFeaturing villager radio with included dialogue, and even playlists for your favorites!",
                      colour=discord.Colour.purple())
page1.set_image(url = 'https://probot.media/FxA6ATuDt3.png')
